    ...
    return (
        <div className="fullComponent">
            ...
            <div className="checkboxes">
                ...
                {
                    Object.keys(boardList).map(function checkboxes(e, i) {
                            return <label className="container" key={i}>
                                {boardList[e]}
                                <input type="checkbox" onChange={handleChange} value={boardList[e]}></input>
